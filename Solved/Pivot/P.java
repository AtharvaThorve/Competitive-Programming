...
public class P {
	...
	public static void main(String[] args) throws IOException {
		...
		for(int i = 1; i < n; ++i) {
			maxL[i] = Helper.max(maxL[i-1], arr[i-1]);
			minR[n-i-1] = Helper.min(minR[n-i], arr[n-i]);
		}

		// fw.println(Arrays.toString(maxL));
		// fw.println(Arrays.toString(minR));
