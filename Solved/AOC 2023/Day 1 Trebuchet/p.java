...
public class p {
	...
	public static void main(String[] args) throws IOException {
        ...
        digitMap.put("one", "one1one");
        digitMap.put("two", "two2two");
        digitMap.put("three", "three3three");
        digitMap.put("four", "four4four");
        digitMap.put("five", "five5five");
        digitMap.put("six", "six6six");
        digitMap.put("seven", "seven7seven");
        digitMap.put("eight", "eight8eight");
        digitMap.put("nine", "nine9nine");
		
		while (qt-- > 0) {
			String s = fs.next();
			for(Map.Entry<String, String> mv: digitMap.entrySet()) {
				s = s.replaceAll(mv.getKey(), mv.getValue());
			}
			int count = 0;
			char x = '0';
			char y = '0';
